...
urlpatterns = patterns('',
                       ...
                       # Group Urls
                       url(r'^groups/(\d+)/user$', views.group_user, name='group users'),
                       url(r'^groups/(\d+)/user/(\d+)$', views.group_user_handle, name='group users handle'),
                       url(r'^groups/(\d+)/user/(\d+)/privileges$', views.group_user_handle_privileges,
